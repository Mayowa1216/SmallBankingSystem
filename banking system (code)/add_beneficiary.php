...
<div class='content_customer'>
    ...
    <form action='add_beneficiary_process.php' method='post'>
        <br><br>
        <h3 style="text-align:center;color:#2E4372;"><u>make a transfer</u></h3>
        <table align="center">
            ...
            <tr><td><span class="heading">Select Branch: </span></td><td><select name='branch_select' required>
                        ...
                        <option value='KOLKATA'>brooklyn</option>
                        <option value='DELHI'>manhantan</option>
                        <option value='BANGALORE'>queens</option>
                        </select></td></tr>
